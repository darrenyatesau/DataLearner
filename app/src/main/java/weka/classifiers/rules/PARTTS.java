...
import weka.classifiers.rules.part.MakeDecListTS;
...
public class PARTTS
	...
	public Capabilities getCapabilities() {
		...
		if (m_unpruned)
			result = new MakeDecListTS(null, m_minNumObj).getCapabilities();
		else if (m_reducedErrorPruning)
			result = new MakeDecListTS(null, m_numFolds, m_minNumObj, m_Seed).getCapabilities();
		else
			result = new MakeDecListTS(null, m_CF, m_minNumObj).getCapabilities();
	...
	public void buildClassifier(Instances instances)
		...
		if (m_unpruned)
			m_root = new MakeDecListTS(modSelection, m_minNumObj);
		else if (m_reducedErrorPruning)
			m_root = new MakeDecListTS(modSelection, m_numFolds, m_minNumObj, m_Seed);
		else
			m_root = new MakeDecListTS(modSelection, m_CF, m_minNumObj);
