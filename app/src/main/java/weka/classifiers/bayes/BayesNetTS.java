...
import weka.classifiers.bayes.net.ADNodeTS;
import weka.classifiers.bayes.net.BIFReaderTS;
import weka.classifiers.bayes.net.ParentSet;
import weka.classifiers.bayes.net.estimate.BayesNetEstimatorTS;
import weka.classifiers.bayes.net.estimate.DiscreteEstimatorBayes;
import weka.classifiers.bayes.net.estimate.SimpleEstimatorTS;
import weka.classifiers.bayes.net.search.SearchAlgorithmTS;
import weka.classifiers.bayes.net.search.local.K2TS;
import weka.classifiers.bayes.net.search.local.LocalScoreSearchAlgorithmTS;
...
public class BayesNetTS
	...
	public void buildClassifier(Instances instances) throws Exception {
		...
		// initialize ADTree
		if (m_bUseADTree) {
			m_ADTree = ADNodeTS.makeADTree(instances);
	...
	public void setOptions(String[] options) throws Exception {
		...
		if (searchAlgorithmName.length() != 0) {
			setSearchAlgorithm(
					(SearchAlgorithmTS) Utils.forName(
							SearchAlgorithmTS.class,
							searchAlgorithmName,
							partitionOptions(options)));
		} else {
			setSearchAlgorithm(new K2TS());
		}
		...
		if (estimatorName.length() != 0) {
			setEstimator(
					(BayesNetEstimatorTS) Utils.forName(
							BayesNetEstimatorTS.class,
							estimatorName,
							Utils.partitionOptions(options)));
		} else {
			setEstimator(new SimpleEstimatorTS());
		}
