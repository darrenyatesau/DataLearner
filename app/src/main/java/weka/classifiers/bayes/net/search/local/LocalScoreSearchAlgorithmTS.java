...
public class LocalScoreSearchAlgorithmTS
	 ...
	 */
	public LocalScoreSearchAlgorithmTS(BayesNetTS bayesNet, Instances instances) {
		m_BayesNet = bayesNet;
//		m_Instances = instances;
	...
	*/
	public void buildStructure (BayesNetTS bayesNet, Instances instances) throws Exception {
		m_BayesNet = bayesNet;
