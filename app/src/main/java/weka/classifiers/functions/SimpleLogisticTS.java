...
import weka.classifiers.trees.lmt.LogisticBaseTS;
...
public class SimpleLogisticTS
	 ...
	 */
	public SimpleLogisticTS(int numBoostingIterations, boolean useCrossValidation,
	...
	public void buildClassifier(Instances data) throws Exception {
		...
		m_boostedModel = new LogisticBaseTS(m_numBoostingIterations, m_useCrossValidation, m_errorOnProbabilities);
	...
	public static void main(String[] argv) {
		runClassifier(new SimpleLogisticTS(), argv);
	}
}
