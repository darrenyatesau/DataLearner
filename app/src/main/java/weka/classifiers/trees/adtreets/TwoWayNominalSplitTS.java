 ...
 */
public class TwoWayNominalSplitTS
  extends SplitterTS {
  ...
  private PredictionNodeTS[] children;
   ...
   */
  public TwoWayNominalSplitTS(int _attIndex, int _trueSplitValue) {

    attIndex = _attIndex; trueSplitValue = _trueSplitValue;
    children = new PredictionNodeTS[2];
  }
   ...
   */
  public ReferenceInstancesTS instancesDownBranch(int branch, Instances instances) {
    
    ReferenceInstancesTS filteredInstances = new ReferenceInstancesTS(instances, 1);
    if (branch == -1) {
   ...
   */
  public boolean equalTo(SplitterTS compare) {

    if (compare instanceof TwoWayNominalSplitTS) { // test object type
      TwoWayNominalSplitTS compareSame = (TwoWayNominalSplitTS) compare;
   ...
   */
  public void setChildForBranch(int branchNum, PredictionNodeTS childPredictor) {
   ...
   * @return the child
   */
  public PredictionNodeTS getChildForBranch(int branchNum) {
  ...
  public Object clone() {
    ...
    TwoWayNominalSplitTS clone = new TwoWayNominalSplitTS(attIndex, trueSplitValue);
    clone.orderAdded = orderAdded;
    if (children[0] != null)
      clone.setChildForBranch(0, (PredictionNodeTS) children[0].clone());
    if (children[1] != null)
      clone.setChildForBranch(1, (PredictionNodeTS) children[1].clone());
    return clone;
  }
