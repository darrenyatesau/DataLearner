 ...
 */
public class TwoWayNumericSplitTS
  extends SplitterTS {
   ...
   */
  public TwoWayNumericSplitTS(int _attIndex, double _splitPoint) {
  ...
  public boolean equalTo(SplitterTS compare) {
    ...
    if (compare instanceof TwoWayNumericSplitTS) { // test object type
      TwoWayNumericSplitTS compareSame = (TwoWayNumericSplitTS) compare;
  ...
  public Object clone() {
    ...
    TwoWayNumericSplitTS clone = new TwoWayNumericSplitTS(attIndex, splitPoint);
