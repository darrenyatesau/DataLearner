 ...
 */
public abstract class SplitterTS
   ...
   */
  public abstract ReferenceInstancesTS instancesDownBranch(int branch, Instances sourceInstances);
   ...
   */
  public abstract boolean equalTo(SplitterTS compare);
   ...
   */
  public abstract void setChildForBranch(int branchNum, PredictionNodeTS childPredictor);
   ...
   * @return the child
   */
  public abstract PredictionNodeTS getChildForBranch(int branchNum);
