...
public class DistributionTS
   ...
   */
  public DistributionTS(double [][] table) {
   ...
   */
  public DistributionTS(Instances source) throws Exception {
  ...
  public DistributionTS(Instances source,
		      ClassifierSplitModelTS modelToUse)
       throws Exception {
   ...
   */
  public DistributionTS(DistributionTS toMerge) {
   ...
   * the indicated one.
   */
  public DistributionTS(DistributionTS toMerge, int index) {
  ...
  public final Object clone() {
    ...
    DistributionTS newDistribution = new DistributionTS (m_perBag.length,
						     m_perClass.length);
    for (i=0;i<m_perBag.length;i++) {
   ...
   * has only one bag.
   */
  public final DistributionTS subtract(DistributionTS toSubstract) {

    DistributionTS newDist = new DistributionTS(1,m_perClass.length);
