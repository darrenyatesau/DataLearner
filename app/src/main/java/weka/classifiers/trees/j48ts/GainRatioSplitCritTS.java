...
import weka.classifiers.trees.j48ts.EntropyBasedSplitCritTS;
 ...
 */
public final class GainRatioSplitCritTS
  extends EntropyBasedSplitCritTS {
   ...
   */
  public final double splitCritValue(DistributionTS bags) {
   ...
   */
  public final double splitCritValue(DistributionTS bags, double totalnoInst,
				     double numerator){
