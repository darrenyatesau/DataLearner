...
import weka.classifiers.trees.j48ts.BinC45SplitTS;
...
import weka.classifiers.trees.j48ts.NoSplitTS;
 ...
 */
public class BinC45ModelSelectionTS
  extends ModelSelectionTS {
   ...
   * split points).  
   */
  public BinC45ModelSelectionTS(int minNoObj,Instances allData){
    m_minNoObj = minNoObj;
    m_allData = allData;
  }
   ...
   */
  public final ClassifierSplitModelTS selectModel(Instances data){

    double minResult;
    double currentResult;
    BinC45SplitTS[] currentModel;
    BinC45SplitTS bestModel = null;
    NoSplitTS noSplitModel = null;
    double averageInfoGain = 0;
    int validModels = 0;
    boolean multiVal = true;
    DistributionTS checkDistribution;
    double sumOfWeights;
    int i;
    ...
    try{
      ...
      checkDistribution = new DistributionTS(data);
      noSplitModel = new NoSplitTS(checkDistribution);
	...
	if ((attribute.isNumeric()) ||
      ...
      currentModel = new BinC45SplitTS[data.numAttributes()];
	...
	if (i != (data).classIndex()){
	  ...
	  currentModel[i] = new BinC45SplitTS(i,m_minNoObj,sumOfWeights);
   ...
   * Selects C4.5-type split for the given dataset.
   */
  public final ClassifierSplitModelTS selectModel(Instances train, Instances test) {
