...
import weka.classifiers.trees.j48ts.SplitCriterionTS;
 ...
 */
public abstract class EntropyBasedSplitCritTS
  extends SplitCriterionTS {
   ...
   */
  public final double oldEnt(DistributionTS bags) {
