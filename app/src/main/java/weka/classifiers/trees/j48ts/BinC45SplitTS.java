...
import weka.classifiers.trees.j48ts.GainRatioSplitCritTS;
import weka.classifiers.trees.j48ts.InfoGainSplitCritTS;
...
public class BinC45SplitTS
  ...
  private void handleEnumeratedAttribute(Instances trainInstances)
    ...
    DistributionTS newDistribution,secondDistribution;
    int numAttValues;
    ...
    newDistribution = new DistributionTS(numAttValues,
	...
	secondDistribution = new DistributionTS(newDistribution,i);
  ...
  private void handleNumericAttribute(Instances trainInstances)
    ...
    m_distribution = new DistributionTS(2,trainInstances.numClasses());
  ...
  public void resetDistribution(Instances data) throws Exception {
    ...
    DistributionTS newD = new DistributionTS(insts, this);
