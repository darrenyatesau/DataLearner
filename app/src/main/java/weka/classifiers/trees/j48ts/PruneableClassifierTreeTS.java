...
public class PruneableClassifierTreeTS
	 ...
	 */
	public PruneableClassifierTreeTS(ModelSelectionTS toSelectLocModel,
...
//---------------------------------------------------------------------------------------------------
	...
	protected ClassifierTreeTS getNewTree(Instances train, Instances test)
		...
		PruneableClassifierTreeTS newTree =
				new PruneableClassifierTreeTS(m_toSelectModel, pruneTheTree, numSets, m_cleanup,
						m_seed);
