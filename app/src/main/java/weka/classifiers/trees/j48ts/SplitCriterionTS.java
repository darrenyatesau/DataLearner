 ...
 */
public abstract class SplitCriterionTS
   ...
   */
  public double splitCritValue(DistributionTS bags){
   ...
   * @return value of splitting criterion. 0 by default
   */
  public double splitCritValue(DistributionTS train, DistributionTS test){
