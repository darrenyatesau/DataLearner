 ...
 */
public class C45ModelSelectionTS
   ...
   */
  public C45ModelSelectionTS(int minNoObj, Instances allData) {
    m_minNoObj = minNoObj;
    m_allData = allData;
  }
  ...
  public final ClassifierSplitModelTS selectModel(Instances data){
    ...
    C45SplitTS[] currentModel;
    C45SplitTS bestModel = null;
	...
	while (enu.hasMoreElements()) {
      ...
      currentModel = new C45SplitTS[data.numAttributes()];
	...
	if (i != (data).classIndex()){
	  ...
	  currentModel[i] = new C45SplitTS(i,m_minNoObj,sumOfWeights);
