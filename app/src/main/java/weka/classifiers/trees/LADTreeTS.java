...
public class LADTreeTS
	 ...
	 *
	 * @throws Exception if try to boost without setting up tree first
	 */
...
//---------------------------------------------------------------------------------------------------
	 ...
	 * @throws Exception if merge could not be performed
	 */
	public void merge(LADTreeTS mergeWith) throws Exception {
	...
	public static void main(String[] argv) {
		runClassifier(new LADTreeTS(), argv);
	}
