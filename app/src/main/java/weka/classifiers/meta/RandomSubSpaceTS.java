...
public class RandomSubSpaceTS
	 ...
	 * Constructor.
	 */
	public RandomSubSpaceTS() {
		super();
		
		m_Classifier = new weka.classifiers.trees.REPTreeTS();
	}
	...
	protected String defaultClassifierString() {
		return "weka.classifiers.trees.REPTreeTS";
	}
...
//---------------------------------------------------------------------------------------------------
	...
	public static void main(String[] args) {
		runClassifier(new RandomSubSpaceTS(), args);
	}
}
