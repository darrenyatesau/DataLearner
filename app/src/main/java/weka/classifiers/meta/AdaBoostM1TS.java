...
public class AdaBoostM1TS
	...
	public AdaBoostM1TS() {
		...
		m_Classifier = new weka.classifiers.trees.DecisionStumpTS();
	}
	...
	protected void buildClassifierUsingResampling(Instances data)
		...
		double epsilon=0, reweight, sumProbs;
		EvaluationTS evaluation;
		int numInstances = data.numInstances();
...
//---------------------------------------------------------------------------------------------------
				...
				evaluation = new EvaluationTS(data);
...
//---------------------------------------------------------------------------------------------------
	...
	public static void main(String[] argv) {
		runClassifier(new AdaBoostM1TS(), argv);
	}
}
